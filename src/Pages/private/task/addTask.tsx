...
export function AddTask({
  ...
  const handleChange = (e: React.ChangeEvent<any>) => {
    ...
    ;
    setForms((prevForms) => ({ ...prevForms, [name]: name == "description" || name === "title" ? value : parseInt(value, 10) }));
  };
        ...
        <div className="px-6 pt-12 pb-8 relative">
          ...
          <div className=" mb-2 flex gap-1 px-2">
            ...
            <div className="flex flex-col  gap-1">
              ...
              <p className="text-gray-600 text-sm mb-6">Create New Task Inside Project</p>
            </div>
          </div>
          <div
          ...
          <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full placeholder:text-sm px-3 py-2 border border-gray-300 rounded-md  focus:border-primary "
              />
