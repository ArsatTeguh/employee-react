...
export function TableEmp({setIsAdd,setCurrentId, currentId, searchQuery,setSearchQuery, data,loading, setIsDelete, pathEdit}: Props) {
          ...
          {loading
            ...
            : data?.employees?.map((value: any, index: number) => (
                <tr key={index}>
                  ...
                  <td
                    className={`border whitespace-nowrap px-4 py-2`}
                  >
                    {value.address}
                  </td>
